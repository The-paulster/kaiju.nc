...
| `MetaExecutionTrace.js` | Debounced execution-trace cache, macro history, assumed-zero inputs, and control-flow safety state | Trace, Sense, future Alert consumers |
